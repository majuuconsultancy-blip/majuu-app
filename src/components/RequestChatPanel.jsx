          ...
          <div className="mt-3">
            ...
            <div className="flex items-end gap-2">
              ...
              <textarea
                ...
                rows={1}
                className="w-full rounded-xl px-3 py-2 text-sm bg-white dark:bg-zinc-900/60 text-zinc-900 dark:text-zinc-100 dark:bg-zinc-900 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 border border-zinc-200 dark:border-zinc-800 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
