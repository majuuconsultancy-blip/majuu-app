...
export default function TravelWeHelp() {
  ...
  const headerDescription = useMemo(() => {
    ...
    if (!safeCountry || safeCountry.toLowerCase() === "not selected") {
      return "Get help with your travel process";
    }
    return `Get help with your ${safeCountry} travel process`;
  }, [country]);
      ...
      >
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <AppIcon size={ICON_LG} icon={Package} className="mt-1 shrink-0 text-emerald-700 dark:text-emerald-200" />
          </div>
