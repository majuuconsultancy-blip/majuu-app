...
export default function TrackSelectScreen() {
  ...
  const Tile = ({ icon, title, desc, onClick, active, delay = 0 }) => (
    <button
      ...
      className={[
        "w-full text-left rounded-3xl border bg-white/70 backdrop-blur p-5 shadow-sm transition",
        "border-zinc-200 hover:border-emerald-200 hover:bg-white hover:shadow-md",
      ...
      <div className="min-h-screen bg-gradient-to-b from-emerald-50/40 via-white to-white dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-950">
        <div className="max-w-xl mx-auto px-5 py-8">
            ...
            <div className={`mt-5 transition ${mounted ? "opacity-100" : "opacity-0"}`}>
              ...
              >
                <span className="inline-flex items-center justify-center gap-2">
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-2xl border border-emerald-200 bg-white/70 text-emerald-800 dark:border-emerald-900/40 dark:bg-zinc-950/40 dark:text-emerald-200">
                    <IconShield className="h-4 w-4" />
                  </span>
                  Staff Portal
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-2xl border border-emerald-200 bg-white/60 text-emerald-800 dark:border-emerald-900/40 dark:bg-zinc-950/40 dark:text-emerald-200">
                    <IconArrowRight className="h-5 w-5" />
                  </span>
                </span>
              </button>
          ...
          {showSkip ? (
            <div
              className={[
                "mt-6 rounded-3xl border border-zinc-200 bg-white/70 p-4 shadow-sm backdrop-blur transition",
            ...
            >
              ...
              <div className="mt-4 grid gap-2">
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-zinc-200 bg-white/50 px-4 py-3 text-sm font-semibold text-zinc-900 transition hover:bg-zinc-50 active:scale-[0.99]
